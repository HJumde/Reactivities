...
type Props={closeForm:()=>void,activity:Activity,submitForm:(activity:Activity)=>void}
    ...
    return (
        <Paper sx={{ borderRadius: 3, padding: 3 }}>
            ...
            <Box component='form' onSubmit={handleSubmit} display='flex' flexDirection='column' gap={3}>
                ...
                <TextField name='discription' label='Description' defaultValue={activity?.discription} multiline rows={3} />
